...
def spawn_ball(direction):
    ...
    ball_pos = [WIDTH / 2, HEIGHT / 2]
    if direction == LEFT:
        ball_vel = [-random.randrange(120, 240) // 100, -random.randrange(60, 100) // 100]
    if direction == RIGHT:
        ball_vel = [random.randrange(120, 240) // 100, -random.randrange(60, 100) // 100]
...
def draw(c):
    ...
    # draw scores
    c.draw_text(str(score1), [WIDTH / 2 - 170, HEIGHT / 6], 50, "White")
    c.draw_text(str(score2), [WIDTH / 2 + 150, HEIGHT / 6], 50, "White")
